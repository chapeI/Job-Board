    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <!-- Nav Item - Pages Collapse Menu -->
      <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseJobSeeker" aria-expanded="true" aria-controls="collapseJobSeeker">
          <i class="fas fa-fw fa-graduation-cap"></i>
          <span>Job Seeker</span>
        </a>
        <div id="collapseJobSeeker" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Job Seeker Header</h6>
            <a class="collapse-item" href="buttons.html">My Applications</a>
            <a class="collapse-item" href="buttons.html">Interviews</a>
          </div>
        </div>
      </li>
